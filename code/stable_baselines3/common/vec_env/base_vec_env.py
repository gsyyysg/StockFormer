...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs: int, observation_space: gym.spaces.Space, action_space: gym.spaces.Space, hidden_state_space: gym.spaces.Space):
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(
        ...
        hidden_state_space: Optional[gym.spaces.Space] = None,
    ):
        self.venv = venv
        VecEnv.__init__(
            self,
            ...
            hidden_state_space=hidden_state_space or venv.hidden_state_space
        )
